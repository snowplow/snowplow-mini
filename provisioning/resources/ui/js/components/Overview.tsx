  ...
  public render() {
    ...
    return (
      <div className="tab-content">
        ...
        <ul>
        <li><b>Snowplow Mini 0.13.3</b></li>
          <li>Snowplow Stream Collector NSQ 2.4.4</li>
          <li>Snowplow Stream Enrich NSQ 2.0.4</li>
          <li>Snowplow Elasticsearch Loader 1.0.3</li>
