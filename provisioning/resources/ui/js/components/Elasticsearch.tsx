  ...
  public render() {
    return (
      <div className="tab-content">
        ...
        <h3>Quicklinks:</h3>
        <ul>
          <li>Link to <a href={'http://' + window.location.hostname + ':5601'}>Kibana</a></li>
          <li>Link to the <a href={'http://' + window.location.hostname + ':9200/_plugin/head'}>Elasticsearch Head Plugin</a></li>
        </ul>
      </div>
    );
  }
