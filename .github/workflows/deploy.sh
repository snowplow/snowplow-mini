...
then
	...
	then
		...
		echo "ELASTICSEARCH_MEM_SIZE=3g" >> provisioning/roles/docker/files/.env
	...
	then
		# prepare env vars for docker-compose
		echo -n > provisioning/roles/docker/files/.env
		echo "ELASTICSEARCH_MEM_SIZE=6g" >> provisioning/roles/docker/files/.env
	...
	then
		# prepare env vars for docker-compose
		echo -n > provisioning/roles/docker/files/.env
		echo "ELASTICSEARCH_MEM_SIZE=12g" >> provisioning/roles/docker/files/.env
